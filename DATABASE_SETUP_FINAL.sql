-- Final Database Setup - Handles Existing Tables and Policies
...
DROP POLICY IF EXISTS "Allow all operations on page_urls" ON page_urls;
...
-- Insert default page URLs (safe to run multiple times)
